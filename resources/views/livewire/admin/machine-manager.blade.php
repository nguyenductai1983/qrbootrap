                        ...
                        <tr>
                            ...
                            <td>
                                @if ($machine->department)
                                    <span class="badge bg-info text-dark">{{ $machine->department->name }}</span>
                                @else
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form wire:submit.prevent="{{ $isEditMode ? 'update' : 'store' }}">
                        <div class="mb-3">
                            <label class="form-label" for="machineCode">Mã Máy <span class="text-danger">*</span></label>
                            <input type="text" wire:model="code" id="machineCode"
                                class="form-control text-uppercase" placeholder="VD: MD-01">
                            @error('code')
                        ...
                        <div class="mb-3">
                            <label class="form-label" for="machineName">Tên Máy <span class="text-danger">*</span></label>
                            <input type="text" wire:model="name" id="machineName"
                                class="form-control" placeholder="VD: Máy Dệt 01">
                            @error('name')
                                <span class="text-danger small">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            <label class="form-label" for="machineDept">Phân Xưởng <span class="text-danger">*</span></label>
